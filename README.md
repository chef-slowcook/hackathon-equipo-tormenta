# hackathon-equipo-tormenta
Crear solución para evaluar con machine learning time series de precipitación en Galapagos

Visualización de datos:  https://weathergsc.usfq.edu.ec
